...
**Translator 1** (`agents/translators/translator-1-en-fr.md`)
...
**Translator 2** (`agents/translators/translator-2-fr-it.md`)
...
**Translator 3** (`agents/translators/translator-3-it-en.md`)
...
**Embedding Analyzer** (`agents/orchestrators/embedding-analyzer.md`)
...
**Translation Experiment Orchestrator** (`agents/orchestrators/translation-experiment-orchestrator.md`)
...
**Batch Experiment Orchestrator** (`agents/orchestrators/batch-experiment-orchestrator.md`)
